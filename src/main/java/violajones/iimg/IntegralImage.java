...
package violajones.iimg;

import ij.process.ByteProcessor;

/**
 * This class represents an integral image, as described 
 * in the book.
 * 
 * @author W. Burger
 *
...
public class IntegralImage {
	 ...
	 * @return
	 */
	public long getBlockSum1(int u0, int v0, int u1, int v1) {
		return S1[u1][v1] + S1[u0][v0] - S1[u0][v1] - S1[u1][v0];
	}
