package violajones.lib; // MODIFIED from version in violajones0
...
public class Detector {
	 ...
	 * @param xmlFileName
	 *        The XML file (generated by OpenCV) describing the Haar Cascade.
	 * @return The corresponding detector.
	 */
	public static Detector create(String xmlFileName, Parameters params) {
		return new Detector(HaarCascadeDescriptor.createFrom(xmlFileName), params);
	}
	
	public static Detector create(InputStream xmlStrm, Parameters params) {
		return new Detector(HaarCascadeDescriptor.createFrom(xmlStrm), params);
	}
	
//	@Deprecated
//	public static Detector create(String filename) {
//		return create(filename, new Parameters());
//	}
	 ...
	 * @param params
	 */
	public Detector(HaarCascadeDescriptor classifier, Parameters params) {
	 ...
	 *         pixels.
	 */
	public List<FaceRegion> getFaces(ByteProcessor ip) {
		return getFaces(ip.getIntArray());
	}
	
	public List<FaceRegion> getFaces(int[][] I) {
